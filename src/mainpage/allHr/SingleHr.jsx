...
export default function SingleHr() {
    ...
    const arr1 = ['Hiring', 'Management', 'Statistic'];
    ...
    return (
        ...
        <div className="bg-color">
            ...
            <MidHeader />
                <h2><span><a href="/hr/">{id}</a></span></h2>
                ...
                <div  >
                    {inProductClicked && <HrDetail detailselected={selectedDetail} productselected = {id} />}
                </div>
            </div>
        </div>
    )
