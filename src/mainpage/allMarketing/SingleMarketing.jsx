...
export default function SingleMarketing() {
    ...
    const arr1 = ['Analytics', 'Management', 'Advertising'];
    ...
    return (
        ...
        <div className="bg-color">
            ...
            <MidHeader />
                <h2><span><a href="/marketing/">{id}</a></span></h2>
                ...
                <div  >
                    {inProductClicked && <MarketingDetail detailselected={selectedDetail} productselected = {id} />}
                </div>
            </div>
        </div>
    )
