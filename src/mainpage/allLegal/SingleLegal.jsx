...
export default function SingleLegal() {
    ...
    const arr1 = ['Validity', 'Formation', 'Statistic'];
    ...
    return (
        ...
        <div className="bg-color">
            ...
            <MidHeader />
                <h2><span><a href="/legal/">{id}</a></span></h2>
                ...
                <div  >
                    {inProductClicked && <LegalDetail detailselected={selectedDetail} productselected = {id} />}
                </div>
            </div>
        </div>
    )
