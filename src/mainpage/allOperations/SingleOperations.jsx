...
import OperationDetail from './OperationDetails';
// import MarketingDetail from './MarketingDetail';

export default function SingleOperations() {
    ...
    const arr1 = ['Prevention', 'Appraisal costs', 'Internal Failure', 'External Failure'];
    ...
    return (
        ...
        <div className="bg-color">
            ...
            <MidHeader />
                <h2><span><a href="/operations/">{id}</a></span></h2>
                ...
                <div  >
                    {inProductClicked && <OperationDetail detailselected={selectedDetail} productselected = {id} />}
                </div>
            </div>
        </div>
    )
