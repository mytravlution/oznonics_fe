    ...
    return (
        ...
        <div className="bg-color">
            ...
            <div className="products-outer">
                ...
                <div className="products-inner"><Link to="/product/HR300" style={{ color: "black" }}><button onClick={onProductClicked} className="product-button" value=''  >HR300</button></Link></div>
                <div className="products-inner"><Link to="/product/HR400" style={{ color: "black" }}><button onClick={onProductClicked} className="product-button" value=''  >HR400/Orion</button></Link></div>
                <div className="products-inner"><Link to="/product/Orion2" style={{ color: "black" }}><button onClick={onProductClicked} className="product-button" value=''  >Orion2</button></Link></div>
                <div className="products-inner"><Link to="/product/Pulse" style={{ color: "black" }}><button onClick={onProductClicked} className="product-button" value=''  >Pulse</button></Link></div>
