            ...
            <div className="detail-outer">
                ...
                <div className="detail-inner">
                    {arr1.map((cat, index) => {
                        return (
                            <div>
                                <button data-index={index} className={buttonValue.toString() === index.toString() ? 'detail-button selected' : 'detail-button'} value={cat} onClick={onProductClicked}>{cat}</button>
                            </div>
                        )
                    })}
                </div>
