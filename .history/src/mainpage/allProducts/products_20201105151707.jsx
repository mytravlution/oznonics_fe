    ...
    return (
        ...
        <div className="bg-color">
            ...
            <div className="products-outer">
                ...
                <div className="products-inner"><Link to="/product/HR400" style={{ color: "black" }}><button onClick={onProductClicked} className="product-button" Orion'  >HR400/Orion</button></Link></div>
                <div className="products-inner"><Link to="/product/Orion2" style={{ color: "black" }}><button onClick={onProductClicked} className="product-button"2'  >Orion2</button></Link></div>
