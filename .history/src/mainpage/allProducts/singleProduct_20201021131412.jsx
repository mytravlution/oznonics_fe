            ...
            <div className="detail-outer">
                ...
                <div className="detail-inner">
                    {arr1.map((cat, index) => {
                        return (
                            <div>
                                {buttonValue.toString() === index.toString() ? "yes"}
                                <button data-index={index} className={buttonValue.toString() === index.toString() ? 'detail-button selected' : 'detail-button'} value={cat} onMouseOver={onProductClicked}>{cat}</button>
                            </div>
                        )
                    })}
                </div>
