        ...
        <div className="bg-color">
            ...
            <div className="detail-outer">
                ...
                <div className="detail-inner">
                    <button className="detail-button" value = "mechanical"  id="number" onMouseEnter={onProductClicked} >Mechanical</button></div>
                    ...
                    <div><button className="detail-button" value ="testing" onMouseEnter={onProductClicked}>Testing</button></div>
                    <div><button className="detail-button" value ="peripherals" onMouseEnter={onProductClicked}>Product Accessories and Peripherals</button></div>
                    <h3>{category}</h3>
                </div>
