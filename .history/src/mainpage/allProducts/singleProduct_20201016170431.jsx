...
export default function Products() {
    ...
    const onProductClicked = (event) => {
        ...
        console.log("id" + id);
    const myvar = document.getElementById("val").value;        
        ...
        <div className="bg-color">
            ...
            <div className="detail-outer">
                ...
                <div className="detail-inner">
                    <div><button className="detail-button" value = 'mechanical'  id="number" onClick={onProductClicked} onInput={e => setPhone(e.target.value)}>Mechanical</button></div>
                ...
                <div className="category-outer">
                    {inProductClicked && <ProductDetail detailselected={myvar}/>}
                </div>
            </div>
        </div>
    )
