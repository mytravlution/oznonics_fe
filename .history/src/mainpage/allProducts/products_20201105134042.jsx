    ...
    return (
        ...
        <div className="bg-color">
            ...
            <div className="products-outer">
                ...
                <div className="products-inner"><Link to="/product/HR400" style={{ color: "black" }}><button onClick={onProductClicked} className="product-button" value={cat.toLowerCase()}  value={cat.toLowerCase()}  >HR400/Orion</button></Link></div>
