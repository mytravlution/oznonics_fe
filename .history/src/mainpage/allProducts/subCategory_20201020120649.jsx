...
export default function SubCategory({ subCategorySelected, detailSelected }) {
    ...
    else if ((detailSelected === "electrical") && ((subCategorySelected === "new component dev") ||  (subCategorySelected === "inline changes") ||  (subCategorySelected === "costing")||(subCategorySelected === "bom")       arr1.push('Main Unit', 'Battery Pack & Charger');
    }
