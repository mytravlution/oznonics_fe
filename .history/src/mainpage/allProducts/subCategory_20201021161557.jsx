...
export default function SubCategory({ subCategorySelected, detailSelected }) {
    ...
    const [ssecondLevel, setSubCategory] = useState('');
    ...
    return (
        <div>
            <div className="prodDetail-outer">
                ...
                <div>
                    {isSubCategoryClicked && <SecondLevel subCategorySelected={subCategorySelected} detailSelected={detailSelected} secondLevelSelected={subCategory} /> }
                </div>
        </div>
    )
}
