            ...
            <div className="detail-outer">
                ...
                <div className="detail-inner">
                    {arr1.map((cat, index) => {
                        return (
                            <div>
                                <button data-index={index} className={buttonValue.toString() === index.toString() ? 'detail-button' : 'sub-category-inner'} value={cat} onClick={onSubCategoryClicked}>{cat}</button>
                            </div>
                        )
                    })}
                </div>
