    ...
    return (
        <div>
            <div className="prodDetail-outer">
                ...
                {arr1.map((cat, index) => {
                    return (
                        <button   data-index={index} className={ buttonValue.toString() === index.toString() ? 'clicked-button sub-category-button-color':'category-inner'} value={cat}  onClick={onSubCategoryClicked}>{cat}</button>
