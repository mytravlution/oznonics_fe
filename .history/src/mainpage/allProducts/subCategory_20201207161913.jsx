                ...
                {arr1.map((cat, index) => {
                    ...
                    return (
                        <div >
                            ...
                            className={buttonValue.toString() === index.toString() ? 'sub-category-format sub-category-clicked' : ' sub-category-format sub-category-unclick'} value={cat.toLowerCase()} onMouseEnter={onSubCategoryClicked}>{cat}</button>
                        </div>
                    )
