        ...
        <div className="bg-color">
            ...
            <div className="detail-outer">
                ...
                <div style={{ marginTop: "30px" }}>
                    ...
                    <div><button className="detail-button">Electronics</button></Link></div>
                    <div><button className="detail-button">Electrical</button></Link></div>
                    <div><button className="detail-button">Testing</button></Link></div>
                    <div><button className="detail-button">Product Accessories and Peripherals</button></Link></div>
                </div>
