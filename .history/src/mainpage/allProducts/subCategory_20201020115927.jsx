...
export default function SubCategory({ subCategorySelected, detailSelected }) {
    ...
    ((subCategorySelected === "new component dev") || 
    (subCategorySelected === "inline changes") ||
    (subCategorySelected === "costing")||
    (subCategorySelected === "bom")
        )) {
        arr1.push('Main Unit', 'Battery Pack & Charger');
    }
    else if ((detailSelected === "testing") && ((subCategorySelected === "testing  protocols") || (subCategorySelected === "testing setup"))) {
        arr1.push('Main Unit', 'Battery Pack & Charger','Battery Charger','Other Components');
    }
    else if ((detailSelected === "testing") && ((subCategorySelected === "Test Results") || (subCategorySelected === "testing setup"))) {
        arr1.push('Main Unit', 'Battery Pack & Charger','Battery Charger','Other Components');
    }
    return (
        <div>
