                ...
                {arr1.map((cat, index) => {
                    return (
                        <div>
                            ...
                            <button   data-index={index} className={ buttonValue.toString() === index.toString() ? 'clicked-button':'sub-category-inner'} value={cat}  onClick={onSubCategoryClicked}>{cat}</button>
                        </div>
                    )
                })}
            </div>
