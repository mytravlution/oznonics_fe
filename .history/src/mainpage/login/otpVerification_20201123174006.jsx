...
export default function OtpVerification({ mobile_number, username, user_type }) {
    ...
    return (
        <div>
             {!loggedIn && <otpVerifyfunc  mobile_number={mobile_number} username={username} user_type={user_type} verifyMobile={verifyMobile} />}
      {/* {loggedIn && <Products />} */}
...
function otpVerifyfunc({ mobile_number, username, user_type }){
