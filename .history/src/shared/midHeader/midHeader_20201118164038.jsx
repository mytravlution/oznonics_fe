    ...
    return (
      <div>
        <div className="search-bar">
          ...
          {(this.state.showFiles) && <ListFiles dataValues={this.state.dataValues} />}
          {(this.state.showFiles) && <Redirect to="/listFile" data={this.state.dataValues} />}
